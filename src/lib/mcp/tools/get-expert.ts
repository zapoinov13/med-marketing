...
export default defineTool({
  name: "get_expert",
  title: "Об эксперте",
  description: "Возвращает информацию о Юрии Валерьевиче — эксперте, который проводит неделю маркетинга для компаний.",
  inputSchema: {},
  ...
  handler: () => {
    const expert = {
      ...
      highlights: [
        ...
        "Личное участие в каждом проекте на неделе",
